...
module.exports.renderUpdateListing = async (req, res) => {
  ...
  let originalListingUrl = editlisting.image?.[0]?.url;
  originalListingUrl = originalListingUrl.replace(
    "/upload",
    "/upload/h_140,w_110",
  );
...
module.exports.deleteImage = async (req, res) => {
  ...
  const publicId = filename.split("/").pop();
